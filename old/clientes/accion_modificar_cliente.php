<?php	
	...
	if (isset($_SESSION["cliente"])) {
		...
		$excepcion = modificar_cliente($conexion,$cliente["ID_CLIENTE"],$cliente["NOMBRE"],$cliente["APELLIDOS"],$cliente["FECHA_NACIMIENTO"],$cliente["EMAIL"],$cliente["CP"],$cliente["TELEFONO"],$cliente["DIRECCION"]);
